...
_How to test the popup: scroll about halfway down this page and it slides up. Move the cursor to the top edge of the window to test the exit-intent trigger. It shows at most once per week — append `?popup=1` to the URL to force it again. The popup now captures an email for the Hermes Kit model scorecard._
...
Donec scelerisque libero at augue posuere, id gravida justo faucibus. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Proin fermentum nibh nec orci tincidunt, sed aliquet metus cursus.

Nullam vitae orci eu purus vehicula malesuada. Vivamus tincidunt felis id mi consequat, sed fermentum velit tincidunt. Cras aliquam risus vel nunc malesuada, in vehicula arcu dictum. Morbi viverra nulla eget nibh tincidunt, at vulputate leo commodo. Fusce ultricies justo eget velit iaculis, at condimentum ligula pellentesque.
